...
# sobrescrever métodos decorados com o @property


class Superclasse:
    @property
    def minha_propriedade(self):
        return "Propriedade da superclasse"


class Subclasse(Superclasse):
    @property
    def minha_propriedade(self):
        return super().minha_propriedade + ", mas agora na subclasse"


obj = Subclasse()
print(obj.minha_propriedade)
